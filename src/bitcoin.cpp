...
Options:
  -m, --multiprocess     Run multiprocess binaries vargamesh-node, vargamesh-gui.
  -M, --monolithic       Run monolithic binaries vargameshd, vargamesh-qt. (Default behavior)
  -v, --version          Show version information
  -h, --help             Show full help message

Commands:
  gui [ARGS]     Start GUI, equivalent to running 'vargamesh-qt [ARGS]' or 'vargamesh-gui [ARGS]'.
  node [ARGS]    Start node, equivalent to running 'vargameshd [ARGS]' or 'vargamesh-node [ARGS]'.
  rpc [ARGS]     Call RPC method, equivalent to running 'vargamesh-cli -named [ARGS]'.
  wallet [ARGS]  Call wallet command, equivalent to running 'vargamesh-wallet [ARGS]'.
  tx [ARGS]      Manipulate hex-encoded transactions, equivalent to running 'vargamesh-tx [ARGS]'.
...
Additional less commonly used commands:
  ...
  test-gui [ARGS]   Run GUI unit tests, equivalent to running 'test_vargamesh-qt [ARGS]'.
)";
...
int main(int argc, char* argv[])
{
    ...
    try {
        ...
        if (cmd.show_help || cmd.command.empty()) {
            ...
            args.emplace_back(UseMultiprocess(cmd) ? "vargamesh-gui" : "vargamesh-qt");
        } else if (cmd.command == "node") {
            args.emplace_back(UseMultiprocess(cmd) ? "vargamesh-node" : "vargameshd");
        } else if (cmd.command == "rpc") {
            args.emplace_back("vargamesh-cli");
            ...
            args.emplace_back("vargamesh-wallet");
        } else if (cmd.command == "tx") {
            args.emplace_back("vargamesh-tx");
            ...
            args.emplace_back("test_vargamesh-qt");
        } else if (cmd.command == "util") {
            args.emplace_back("vargamesh-util");
        } else {
...
//! Execute the specified vargameshd, vargamesh-qt or other command line in `args`
...
//!             be a relative path to a vargameshd, vargamesh-qt or other executable

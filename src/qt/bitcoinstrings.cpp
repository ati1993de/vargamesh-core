...
QT_TRANSLATE_NOOP("bitcoin-core", "Error: Dumpfile version is not supported. This version of vargamesh-wallet only supports version 1 dumpfiles. Got dumpfile with version %s"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Prune mode is disabled on VargaMesh mainnet because complete historical AuxPoW headers must remain available."),
...
QT_TRANSLATE_NOOP("bitcoin-core", "VargaMesh node startup supports only mainnet and regtest. Inherited Bitcoin testnet3, testnet4, and signet are disabled."),

...
BOOST_AUTO_TEST_CASE(valid_keys)
{
    ...
    std::vector<BIP328TestVector> test_vectors = {
        // Test vector 0
        {
            ...
            .expected_aggregate_xpub = "VMPULNojPHWzovqgVmEE9CqMyPKRE5X7wPHwDgcj9CiEMGp9FRe24NgN6yJdqeAqMmf8ZCDQ43cgBy6gmu9nxvGm9gCYosJpZqxZEzsUzTFurT5"
        },
        // Test vector 1
        {
            .pubkeys = {
            ...
            .expected_aggregate_xpub = "VMPULNojPHWzovqgVmEE9CqMyPKRE5X7wPHwDgcj9CiEMGp9FRe24NgN6yJdqcgbYn9xh8vP9sujGTDegxQh8eCXXpy26GYAtB7X3eofNKV5XC9"
        },
        // Test vector 2
        {
            .pubkeys = {
            ...
            .expected_aggregate_xpub = "VMPULNojPHWzovqgVmEE9CqMyPKRE5X7wPHwDgcj9CiEMGp9FRe24NgN6yJdqbs6f5gCS1WNb5MQ7yTGW71MCMaH3q8RtproPhmk41exN99hfNS"
        }
    };

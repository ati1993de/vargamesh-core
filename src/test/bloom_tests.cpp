...
{
    std::string strSecret = std::string("7QCAd9ziQibN5ojRbkkPBHqST6wctbfDNMXoRVCmC2VVVxJFi3A");
...
BOOST_AUTO_TEST_CASE(merkle_block_2)
{
    ...
    // Match an output from the second transaction (the pubkey for address VPDgvB3TAqnShPAzBgWJ1caRV8nhzCsAoG)

...
static const std::string addr1 = "VZv4kxLNmhzpHj4J1wCtFyvUq3NUrsYayh";
static const std::string addr2 = "VQkBzpwR4EWtEy4wtX1eXFh86aFyxCEJSo";
static const std::string addr1C = "VYTXnQk3f1ceuY3y1tmNEMgNuqTFuhsZUx";
static const std::string addr2C = "VN5wwtqWhpxrEcvb3nD2D82kjgVBGZyjMv";

static const std::string strAddressBad = "VT9NGCv34v1JC4pdTTyUyuwJpVu1eE6dYy";
